...
des <- svydesign(
  ...
  nest = TRUE)
young_adults <- subset(des, CATAGE == 2 & IRMJFY > 0)  #CATAGE==2 for 18–25
```
...
ggplot(plotdat_or, aes(x = IRMJFY, y = OR)) +
  ...
  labs(x = "Past-Year Marijuana Use",
       y = paste0("Odds Ratio (vs Odds Ratio for ", signif(ref_value, 4)," Days of \nMarijuana Use)"),
       title = "Survey-weighted Restricted Cubic Splines: \nOdds Ratio vs Past Year Marijuana Use (days)") +
