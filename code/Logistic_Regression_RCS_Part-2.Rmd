...
vars <- c(
  ...
  "IRNICVAP30N","IRALCBNG30D","SUTINPPY","IRDSTNRV12","IRIMPCONCN","IRMJFY_std","IRCOCFY_std","IRHALLUCYFQ_std",
  #Dummy columns (omit reference category dummy!)
  "NEWRACE2_2","NEWRACE2_3","NEWRACE2_4","NEWRACE2_5","NEWRACE2_6","NEWRACE2_7",
  "IRWRKSTAT18_2","IRWRKSTAT18_3","IRWRKSTAT18_4",
  #Domain variable
...
fit_rcs <- svyglm(
  IRSUICTHNK ~ rcs(IRMJFY_std) +
    rcs(IRCOCFY_std) +
    rcs(IRHALLUCYFQ_std) + IRSEX + EDUHIGHCAT + IRPRVHLT + IRHHSIZ2 + INCOME +
    IRALCFY + IRCIGFM + IRNICVAP30N + IRALCBNG30D + SUTINPPY +
    IRDSTNRV12 + IRIMPCONCN +
    NEWRACE2_2 + NEWRACE2_3 + NEWRACE2_4 + NEWRACE2_5 + NEWRACE2_6 + NEWRACE2_7 +
    IRWRKSTAT18_2 + IRWRKSTAT18_3 + IRWRKSTAT18_4,
...
regTermTest(fit_rcs, ~ rcs(IRCOCFY_std))
regTermTest(fit_rcs, ~ rcs(IRHALLUCYFQ_std))
```
