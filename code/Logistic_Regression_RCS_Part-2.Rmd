...
fit <- svyglm(IRSUICTHNK ~ IRMJFY_std + IRCOCFY_std + IRHALLUCYFQ_std, design = young_adults, family = quasibinomial())
...
#Fit linear model
fit_linear <- svyglm(
  IRSUICTHNK ~ IRMJFY_std + IRCOCFY_std + IRHALLUCYFQ_std,
  design = young_adults,
