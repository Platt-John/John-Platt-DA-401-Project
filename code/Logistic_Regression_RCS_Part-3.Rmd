...
ess <- (sum(w)^2) / sum(w^2)
print(ess)
print(nrow(subset(data, CATAGE == 2 & (IRDSTNRV12=="All of the time" | IRDSTNRV12=="Most of the time"))))
#Subgroup2
...
ess <- (sum(w)^2) / sum(w^2)
print(ess)
print(nrow(subset(data, CATAGE == 2 & (IRDSTNRV12=="Some of the time" | IRDSTNRV12=="A little of the time" | IRDSTNRV12=="None of the time"))))
```
...
```{r unadjusted pseudo maximum likelihood logistic regression 1 1}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRSEX 1}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
...
```{r plot residuals vs fitted values for unadjusted PML model 2 2}
res_dev <- residuals(fit, type = "deviance")
plot(fitted(fit), res_dev, xlab="Fitted (p-hat)", ylab="Deviance residuals",
     main="Residuals vs Fitted (Deviance)", pch=19, col="steelblue")
abline(h=0, lty=2, col="red")
...
```{r unadjusted pseudo maximum likelihood logistic regression for EDUHIGHCAT 1}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
...
```{r plot residuals vs fitted values for unadjusted PML model 3 3}
res_dev <- residuals(fit, type = "deviance")
plot(fitted(fit), res_dev, xlab="Fitted (p-hat)", ylab="Deviance residuals",
     main="Residuals vs Fitted (Deviance)", pch=19, col="steelblue")
abline(h=0, lty=2, col="red")
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRPRVHLT 1}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
...
```{r plot residuals vs fitted values for unadjusted PML model 4 4}
res_dev <- residuals(fit, type = "deviance")
plot(fitted(fit), res_dev, xlab="Fitted (p-hat)", ylab="Deviance residuals",
     main="Residuals vs Fitted (Deviance)", pch=19, col="steelblue")
abline(h=0, lty=2, col="red")
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRHHSIZ2 5}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
...
```{r plot residuals vs fitted values for unadjusted PML model 5 5}
res_dev <- residuals(fit, type = "deviance")
plot(fitted(fit), res_dev, xlab="Fitted (p-hat)", ylab="Deviance residuals",
     main="Residuals vs Fitted (Deviance)", pch=19, col="steelblue")
abline(h=0, lty=2, col="red")
...
```{r unadjusted pseudo maximum likelihood logistic regression for INCOME 6}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
...
```{r plot residuals vs fitted values for unadjusted PML model 6 6}
res_dev <- residuals(fit, type = "deviance")
plot(fitted(fit), res_dev, xlab="Fitted (p-hat)", ylab="Deviance residuals",
     main="Residuals vs Fitted (Deviance)", pch=19, col="steelblue")
abline(h=0, lty=2, col="red")
...
```{r unadjusted pseudo maximum likelihood logistic regression FOR IRALCFY 7}
#Fit unadjusted logistic regression model between alcohol use and suicidal ideation
...
```{r plot residuals vs fitted values for unadjusted PML model 7 7}
res_dev <- residuals(fit, type = "deviance")
plot(fitted(fit), res_dev, xlab="Fitted (p-hat)", ylab="Deviance residuals",
     main="Residuals vs Fitted (Deviance)", pch=19, col="steelblue")
abline(h=0, lty=2, col="red")
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRCIGFM 8}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
...
```{r plot residuals vs fitted values for unadjusted PML model 8 8}
res_dev <- residuals(fit, type = "deviance")
plot(fitted(fit), res_dev, xlab="Fitted (p-hat)", ylab="Deviance residuals",
     main="Residuals vs Fitted (Deviance)", pch=19, col="steelblue")
abline(h=0, lty=2, col="red")
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRNICVAP30N 9}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
...
```{r plot residuals vs fitted values for unadjusted PML model 9 9}
res_dev <- residuals(fit, type = "deviance")
plot(fitted(fit), res_dev, xlab="Fitted (p-hat)", ylab="Deviance residuals",
     main="Residuals vs Fitted (Deviance)", pch=19, col="steelblue")
abline(h=0, lty=2, col="red")
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRALCBNG30D 10}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
...
```{r plot residuals vs fitted values for unadjusted PML model 10 10}
res_dev <- residuals(fit, type = "deviance")
plot(fitted(fit), res_dev, xlab="Fitted (p-hat)", ylab="Deviance residuals",
     main="Residuals vs Fitted (Deviance)", pch=19, col="steelblue")
abline(h=0, lty=2, col="red")
...
```{r unadjusted pseudo maximum likelihood logistic regression for SUTINPPY 11}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
...
```{r plot residuals vs fitted values for unadjusted PML model 11 11}
res_dev <- residuals(fit, type = "deviance")
plot(fitted(fit), res_dev, xlab="Fitted (p-hat)", ylab="Deviance residuals",
     main="Residuals vs Fitted (Deviance)", pch=19, col="steelblue")
abline(h=0, lty=2, col="red")
...
```{r unadjusted pseudo maximum likelihood logistic regression for difficulty concentrating 12}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
...
```{r plot residuals vs fitted values for unadjusted PML model 13 13}
res_dev <- residuals(fit, type = "deviance")
plot(fitted(fit), res_dev, xlab="Fitted (p-hat)", ylab="Deviance residuals",
     main="Residuals vs Fitted (Deviance)", pch=19, col="steelblue")
abline(h=0, lty=2, col="red")
...
```{r unadjusted pseudo maximum likelihood logistic regression for NEWRACE2 14}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
...
```{r plot residuals vs fitted values for unadjusted PML model 14 14}
res_dev <- residuals(fit, type = "deviance")
plot(fitted(fit), res_dev, xlab="Fitted (p-hat)", ylab="Deviance residuals",
     main="Residuals vs Fitted (Deviance)", pch=19, col="steelblue")
abline(h=0, lty=2, col="red")
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRWRKSTAT18 15}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
...
```{r plot residuals vs fitted values for unadjusted PML model 15 15}
res_dev <- residuals(fit, type = "deviance")
plot(fitted(fit), res_dev, xlab="Fitted (p-hat)", ylab="Deviance residuals",
     main="Residuals vs Fitted (Deviance)", pch=19, col="steelblue")
abline(h=0, lty=2, col="red")
...
```{r adjusted pseudo maximum likelihood logistic regression 1}
#Fit the adjusted PML logistic regression (quasibinomial for robust SEs)
fit <- svyglm(
  IRSUICTHNK ~ IRMJFY2 + IRSEX + EDUHIGHCAT + IRPRVHLT + IRHHSIZ2 + IRNICVAP30N + SUTINPPY + IRCIGFM + IRIMPCONCN +  IRALCFY + IRALCBNG30D +
               NEWRACE2_2 + NEWRACE2_3 + NEWRACE2_4 + NEWRACE2_5 + NEWRACE2_6 + NEWRACE2_7 +
...
```{r PML adjusted logistic regression with interactions 1}
#Fit the adjusted PML logistic regression (quasibinomial for robust SEs) with interactions
fit_int <- svyglm(
 IRSUICTHNK ~ IRSEX + EDUHIGHCAT + IRPRVHLT + IRHHSIZ2  + IRALCFY + IRALCBNG30D + IRNICVAP30N + SUTINPPY + IRCIGFM + 
                NEWRACE2_2 + IRMJFY2 * NEWRACE2_3 + IRMJFY2 * NEWRACE2_4 + NEWRACE2_5 + NEWRACE2_6 + NEWRACE2_7 + 
...
```{r plot residuals vs fitted values for adjusted PML model 1}
res_dev <- residuals(fit_int, type = "deviance")
plot(fitted(fit_int), res_dev, xlab="Fitted (p-hat)", ylab="Deviance residuals",
     main="Residuals vs Fitted (Deviance)", pch=19, col="steelblue")
abline(h=0, lty=2, col="red")
