...
young_adults1 <- subset(des, CATAGE == 2 & IRDSTNRV12=="All of the time")
...
print(ess)
#Subgroup2
young_adults2 <- subset(des, CATAGE == 2 & IRDSTNRV12=="Most of the time")
#Number of unique strata and PSUs in the subpopulation
...
print(ess)
#Subgroup3
young_adults3 <- subset(des, CATAGE == 2 & IRDSTNRV12=="Some of the time")
#Number of unique strata and PSUs in the subpopulation
length(unique(young_adults3$variables$VESTR_C))
length(unique(young_adults3$variables$VEREP))
#Compute effective sample size
w <- weights(young_adults3)
ess <- (sum(w)^2) / sum(w^2)
print(ess)
#Subgroup4
young_adults4 <- subset(des, CATAGE == 2 & IRDSTNRV12=="A little of the time")
#Number of unique strata and PSUs in the subpopulation
length(unique(young_adults4$variables$VESTR_C))
length(unique(young_adults4$variables$VEREP))
#Compute effective sample size
w <- weights(young_adults4)
ess <- (sum(w)^2) / sum(w^2)
print(ess)
#Subgroup5
young_adults5 <- subset(des, CATAGE == 2 & IRDSTNRV12=="None of the time")
#Number of unique strata and PSUs in the subpopulation
length(unique(young_adults5$variables$VESTR_C))
length(unique(young_adults5$variables$VEREP))
#Compute effective sample size
w <- weights(young_adults5)
ess <- (sum(w)^2) / sum(w^2)
print(ess)
```
...
We do our adjusted and unadjusted logistic regression models for subgroup 3.

```{r unadjusted pseudo maximum likelihood logistic regression}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRMJFY2, design = young_adults3, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRSEX}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRSEX, design = young_adults3, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for EDUHIGHCAT}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ EDUHIGHCAT, design = young_adults3, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRPRVHLT}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRPRVHLT, design = young_adults3, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRHHSIZ2}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRHHSIZ2, design = young_adults3, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for INCOME}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ INCOME, design = young_adults3, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression FOR IRALCFY}
#Fit unadjusted logistic regression model between alcohol use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRALCFY, design = young_adults3, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRCIGFM}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRCIGFM, design = young_adults3, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRNICVAP30N}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRNICVAP30N, design = young_adults3, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRALCBNG30D}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRALCBNG30D, design = young_adults3, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for SUTINPPY}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ SUTINPPY, design = young_adults3, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for difficulty concentrating}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRIMPCONCN, design = young_adults3, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for NEWRACE2}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ NEWRACE2_2 + NEWRACE2_3 + NEWRACE2_4 + NEWRACE2_5 + NEWRACE2_6 + NEWRACE2_7, design = young_adults3, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRWRKSTAT18}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRWRKSTAT18_2 + IRWRKSTAT18_3 + IRWRKSTAT18_4, design = young_adults3, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
We do our adjusted and unadjusted logistic regression models for subgroup 4

```{r unadjusted pseudo maximum likelihood logistic regression}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRMJFY2, design = young_adults4, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRSEX}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRSEX, design = young_adults4, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for EDUHIGHCAT}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ EDUHIGHCAT, design = young_adults4, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRPRVHLT}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRPRVHLT, design = young_adults4, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRHHSIZ2}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRHHSIZ2, design = young_adults4, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for INCOME}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ INCOME, design = young_adults4, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression FOR IRALCFY}
#Fit unadjusted logistic regression model between alcohol use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRALCFY, design = young_adults4, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRCIGFM}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRCIGFM, design = young_adults4, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRNICVAP30N}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRNICVAP30N, design = young_adults4, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRALCBNG30D}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRALCBNG30D, design = young_adults4, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for SUTINPPY}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ SUTINPPY, design = young_adults4, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for difficulty concentrating}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRIMPCONCN, design = young_adults4, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for NEWRACE2}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ NEWRACE2_2 + NEWRACE2_3 + NEWRACE2_4 + NEWRACE2_5 + NEWRACE2_6 + NEWRACE2_7, design = young_adults4, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRWRKSTAT18}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRWRKSTAT18_2 + IRWRKSTAT18_3 + IRWRKSTAT18_4, design = young_adults4, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
We do our adjusted and unadjusted logistic regression models for subgroup 5

```{r unadjusted pseudo maximum likelihood logistic regression}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRMJFY2, design = young_adults5, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRSEX}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRSEX, design = young_adults5, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for EDUHIGHCAT}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ EDUHIGHCAT, design = young_adults5, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRPRVHLT}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRPRVHLT, design = young_adults5, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRHHSIZ2}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRHHSIZ2, design = young_adults5, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for INCOME}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ INCOME, design = young_adults5, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression FOR IRALCFY}
#Fit unadjusted logistic regression model between alcohol use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRALCFY, design = young_adults5, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRCIGFM}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRCIGFM, design = young_adults5, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRNICVAP30N}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRNICVAP30N, design = young_adults5, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRALCBNG30D}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRALCBNG30D, design = young_adults5, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for SUTINPPY}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ SUTINPPY, design = young_adults5, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for difficulty concentrating}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRIMPCONCN, design = young_adults5, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for NEWRACE2}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ NEWRACE2_2 + NEWRACE2_3 + NEWRACE2_4 + NEWRACE2_5 + NEWRACE2_6 + NEWRACE2_7, design = young_adults5, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
...
```{r unadjusted pseudo maximum likelihood logistic regression for IRWRKSTAT18}
#Fit unadjusted logistic regression model between marijuana use and suicidal ideation
fit <- svyglm(IRSUICTHNK ~ IRWRKSTAT18_2 + IRWRKSTAT18_3 + IRWRKSTAT18_4, design = young_adults5, family = quasibinomial())
#Coefficients → ORs with 95% CIs
co <- coef(fit) #Beta coefficients
vc <- vcov(fit) #Variance-covariance matrix
se <- sqrt(diag(vc)) #Standard error
